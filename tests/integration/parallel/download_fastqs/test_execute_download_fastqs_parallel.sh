...
#  Define fixture and output paths for a loopback-only GNU Parallel download
...
log_pfx="${dir_err}/test_execute_download_parallel.SRR_LOCAL_PE"
log_out_r1="${log_pfx}_R1.stdout.txt"
log_err_r1="${log_pfx}_R1.stderr.txt"
log_out_r2="${log_pfx}_R2.stdout.txt"
log_err_r2="${log_pfx}_R2.stderr.txt"
