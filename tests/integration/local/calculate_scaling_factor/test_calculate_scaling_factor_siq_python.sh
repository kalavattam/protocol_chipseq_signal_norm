...
scr_clc="${ROOT_REPO}/src/protocol_chipseq_signal_norm/cli/calculate_scaling_factor_siqchip.py"
...
run_siq_success \
    ...
    -m protocol_chipseq_signal_norm.cli.calculate_scaling_factor_siqchip \
        --eqn 5 \
        "${calc_arg[@]}" \
        --dep_ip 3 \
        --dep_in 5
