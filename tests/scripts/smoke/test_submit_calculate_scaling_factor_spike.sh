...
bam_pe_mip="${dir_bam_pe}/IP_A.sc.bam"
bam_pe_min="${dir_bam_pe}/in_A.sc.bam"
bam_pe_sip="${dir_bam_pe}/IP_A.sp.bam"
bam_pe_sin="${dir_bam_pe}/in_A.sp.bam"

cram_pe_mip="${dir_cram_pe}/IP_A.sc.cram"
cram_pe_min="${dir_cram_pe}/in_A.sc.cram"
cram_pe_sip="${dir_cram_pe}/IP_A.sp.cram"
cram_pe_sin="${dir_cram_pe}/in_A.sp.cram"
