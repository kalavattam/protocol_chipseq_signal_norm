...
# shellcheck disable=SC2034
{
    ...
    arr_fix_scl=(
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep1.sc.bam"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep1.sc.bam.bai"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep2.sc.bam"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep2.sc.bam.bai"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep1.sc.bam"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep1.sc.bam.bai"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep2.sc.bam"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep2.sc.bam.bai"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep1.sp.bam"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep1.sp.bam.bai"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep2.sp.bam"
        "${dir_fix_scl}/bam/se/IP_WT_log_Brn1_rep2.sp.bam.bai"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep1.sp.bam"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep1.sp.bam.bai"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep2.sp.bam"
        "${dir_fix_scl}/bam/se/in_WT_log_Brn1_rep2.sp.bam.bai"
        "${dir_fix_scl}/reference/tiny.fa"
        "${dir_fix_scl}/reference/tiny.fa.fai"
        "${dir_fix_scl}/bam/pe/IP_WT_G1_Hho1_6336.sc.bam"
        "${dir_fix_scl}/bam/pe/IP_WT_G1_Hho1_6336.sc.bam.bai"
        "${dir_fix_scl}/bam/pe/IP_WT_G1_Hho1_6337.sc.bam"
        "${dir_fix_scl}/bam/pe/IP_WT_G1_Hho1_6337.sc.bam.bai"
        "${dir_fix_scl}/bam/pe/in_WT_G1_Hho1_6336.sc.bam"
        ...
        "${dir_fix_scl}/bam/pe/IP_WT_G1_Hho1_6337.sp.bam.bai"
        "${dir_fix_scl}/bam/pe/in_WT_G1_Hho1_6336.sp.bam"
        "${dir_fix_scl}/bam/pe/in_WT_G1_Hho1_6336.sp.bam.bai"
        ...
        "${dir_fix_scl}/metadata/measurements_siqchip_precomputed.tsv"
        "${dir_fix_scl}/metadata/measurements_siqchip_lib_volume.tsv"
        "${dir_fix_scl}/metadata/measurements_siqchip_lib_volume_one_sided.tsv"
        "${dir_fix_scl}/metadata/measurements_siqchip_lib_volume_zero.tsv"
        "${dir_fix_scl}/config/parse_metadata_siqchip_field_to_column.yml"
    )
...
arr_tst=(
    ...
    "${dir_run}/smoke/test_relativize_scaling_factors.sh"
    ...
    "${dir_run}/smoke/test_calculate_scaling_factor_siq_yaml.sh"
    ...
    "${dir_run}/smoke/test_submit_qsort_bam.sh"
    "${dir_run}/smoke/test_submit_convert_bam_bed.sh"
    ...
    "${dir_run}/smoke/test_submit_filter_alignments_bam_to_bam.sh"
    "${dir_run}/smoke/test_execute_filter_alignments_bam_to_bam.sh"
    "${dir_run}/smoke/test_submit_filter_alignments_cram_to_bam.sh"
    "${dir_run}/smoke/test_execute_filter_alignments_cram_to_bam.sh"
