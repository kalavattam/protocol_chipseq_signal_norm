...
================================================================
> **Historical status (pre-7j):** This document is retained as recorded validation evidence, not executable current guidance. Its command examples and repository paths are preserved verbatim to protect the historical record.
