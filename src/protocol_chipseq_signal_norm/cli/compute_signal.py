...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "'--method' produced it.\n"
            "\n"
            "A siQ-ChIP alpha is derived against a ratio of signal types: "
            "equations 5 and 6 for 'frag', 5nd and 6nd for 'norm'.\n"
            "\n"
            "A spike-in alpha is likewise derived against a ratio of signal "
            "types: either 'count' or 'unadj', since the per-bin deposition "
            "difference largely cancels in the division. Earlier spike-in "
            "work used 'count', so prefer it where continuity with those "
            "results matters.\n"
            "\n"
        ),
    )
