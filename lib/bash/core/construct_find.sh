...
-----
  construct_find
    [--help] --arr_nam <str> --dir_fnd <dir> --pattern <str> [--follow] [--depth <int>] [--include <csv>] [--exclude <csv>]
...
----------
  ...
  -an, --arr_nam, --arr_name : str
    Name of the output array variable to populate.

  -df, --dir_fnd, --dir_find : dir
    Directory in which to search for files (required).

  -pa, --patn, --pattern : str
    Primary filename pattern to match (required).

  -fl, -sy, --follow, --symlink : flag
  ...
  -in, --incld, --include : list of str
    Comma-separated list of additional filename patterns to include; each is applied as an additional '-name' predicate, i.e., logical AND.

  -ex, --excld, --exclude : list of str
    Comma-separated list of filename patterns to exclude; each is applied with logical AND NOT.
...
Examples
--------
  1. Build a recursive file search using only the required selectors.
    '''bash
    construct_find \\
        --arr_nam find_cmd \\
        --dir_fnd tests \\
  ...
  2. Build a depth-limited symlink-following search with exclusions.
    '''bash
    construct_find \\
        --arr_nam find_cmd \\
        --dir_fnd tests \\
